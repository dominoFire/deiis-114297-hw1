 ...
 * @generated */
public class Ngram_Type extends PipelineAnnotation_Type {
  /** @generated 
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("mx.itam.deiis.hw1.Ngram");
  ...
  public int getN(int addr) {
      ...
      jcas.throwFeatMissing("n", "mx.itam.deiis.hw1.Ngram");
  ...
  public int getTokens(int addr) {
      ...
      jcas.throwFeatMissing("tokens", "mx.itam.deiis.hw1.Ngram");
